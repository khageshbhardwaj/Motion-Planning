...
def runtest_AStar(mapfile, start, goal, verbose = True):
  ...
  env = AStar.Environment(boundary, blocks)

  # MP = AStar.AStar(boundary, blocks) # TODO: replace this with your own planner implementation
  ...
  path, OPEN_nodes, CLOSED_nodes = AStar.AStar.plan(start, goal, env)
  toc(t0,"Planning")
  ...
  # while generating the new neighbours, we checked at every instant whether the line segment collides
  # with the obstacle or not. If it does, we discard that neighbour and consider only those which lies 
  # in free space. This ensures that the path is always collision free.

  # TODO: You can implement your own algorithm or use an existing library for segment and 
  #       axis-aligned bounding box (AABB) intersection

  collision = False
  goal_reached = np.allclose(path[-1], goal, atol=0.3)
  success = (not collision) and goal_reached
  pathlength = np.sum(np.sqrt(np.sum(np.diff(path,axis=0)**2,axis=1)))
  return success, pathlength, OPEN_nodes, CLOSED_nodes
...
def test_single_cube(verbose = True):
  ...
  success, pathlength, OPEN_nodes, CLOSED_nodes = runtest_AStar('./maps/single_cube.txt', start, goal, verbose)
  print('Success: %r'%success)
  print('Path length: %d'%pathlength)
  print('OPEN nodes: %r'%OPEN_nodes)
  print('CLOSED nodes: %d'%CLOSED_nodes)
  print('\n')
...
def test_maze(verbose = True):
  ...
  success, pathlength, OPEN_nodes, CLOSED_nodes = runtest_AStar('./maps/maze.txt', start, goal, verbose)
  print('Success: %r'%success)
  print('Path length: %d'%pathlength)
  print('OPEN nodes: %r'%OPEN_nodes)
  print('CLOSED nodes: %d'%CLOSED_nodes)
...
def test_window(verbose = True):
  ...
  success, pathlength, OPEN_nodes, CLOSED_nodes = runtest_AStar('./maps/window.txt', start, goal, verbose)
  print('Success: %r'%success)
  print('Path length: %d'%pathlength)
  print('OPEN nodes: %r'%OPEN_nodes)
  print('CLOSED nodes: %d'%CLOSED_nodes)
...
def test_tower(verbose = True):
  ...
  success, pathlength, OPEN_nodes, CLOSED_nodes = runtest_AStar('./maps/tower.txt', start, goal, verbose)
  print('Success: %r'%success)
  print('Path length: %d'%pathlength)
  print('OPEN nodes: %r'%OPEN_nodes)
  print('CLOSED nodes: %d'%CLOSED_nodes)
...
def test_flappy_bird(verbose = True):
  ...
  success, pathlength, OPEN_nodes, CLOSED_nodes = runtest_AStar('./maps/flappy_bird.txt', start, goal, verbose)
  print('Success: %r'%success)
  print('Path length: %d'%pathlength)
  print('OPEN nodes: %r'%OPEN_nodes)
  print('CLOSED nodes: %d'%CLOSED_nodes)
...
def test_room(verbose = True):
  ...
  success, pathlength, OPEN_nodes, CLOSED_nodes = runtest_AStar('./maps/room.txt', start, goal, verbose)
  print('Success: %r'%success)
  print('Path length: %d'%pathlength)
  print('OPEN nodes: %r'%OPEN_nodes)
  print('CLOSED nodes: %d'%CLOSED_nodes)
...
def test_monza(verbose = True):
  ...
  success, pathlength, OPEN_nodes, CLOSED_nodes = runtest_AStar('./maps/monza.txt', start, goal, verbose)
  print('Success: %r'%success)
  print('Path length: %d'%pathlength)
  print('OPEN nodes: %r'%OPEN_nodes)
  print('CLOSED nodes: %d'%CLOSED_nodes)
